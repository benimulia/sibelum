...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Register | SiBelum UKDW</title>
        <style>
            body{
...
<section class= "jumbotron"><br><br><br>
<div class="container">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="level" type="hidden" class="form-control @error('level') is-invalid @enderror" name="level" value="alumni" required autocomplete="level" readonly>
