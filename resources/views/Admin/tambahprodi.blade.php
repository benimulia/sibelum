...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <form action="/admin/tambahprodi/create" class="needs-validation" novalidate method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id" id="id">
            @csrf
            <div class="form-group">
                <label for="fakultas">Pilih Fakultas  :</label>
                <div class="form-group">
                    <select class="form-control" id="idfakultas" name="idfakultas">
